...
export async function createRestrictedDisplay(mnemonic, publisherId, packageId, suiNetwork, displayKeys, displayValues, braavVersion) {
  try {
    ...
    console.error("Error creating restricted display:", error.message);
    throw error;
  }
}